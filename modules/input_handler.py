...
class InputHandler:
    ...
    def audio_to_text_from_file(self, filepath: str = None):
        """
        从录音文件中读取音频数据并进行语音识别。
        :return:
        """
    ...
    def audio_to_text_from_types(self, audio_wav_buffer: BytesIO):
        """
...
def record_and_transcribe_speech():
